            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2">
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        <li class="nav-item">
                            <a href="<?php echo site_url('mainpage/index'); ?>" class="nav-link">
                        ...
                        <!-- Dosen Menu Item -->
                        <li class="nav-item">
                            <a href="<?php echo site_url('dosen/index'); ?>" class="nav-link">
                                <i class="nav-icon bi bi-person-badge"></i>
                                <p>Dosen</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo site_url('matkul/index'); ?>" class="nav-link">
